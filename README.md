# The Art of Writing Efficient Programs – Lab
...
* Explore **cache behavior**, **branch prediction**, and **memory access patterns**
...
* Implementations of examples from the book (C / C++)
